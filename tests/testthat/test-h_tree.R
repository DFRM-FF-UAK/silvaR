...
test_that("h_tree returns correct heights for use_measured_height = T", {
...
test_that("h_tree returns correct heights for use_measured_height = F", {
  result <- h_tree(plot_id = plot_id, tree_id = tree_id, species = species, age = age,
...
test_that("h_tree warns for species without parameters", {
